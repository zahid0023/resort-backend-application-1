...
public interface FacilityPriceTypeRepository extends
        JpaRepository<@NonNull FacilityPriceTypeEntity, @NonNull Long>,
    ...
    Optional<FacilityPriceTypeEntity> findByCodeAndIsActiveAndIsDeleted(String code, Boolean isActive, Boolean isDeleted);
