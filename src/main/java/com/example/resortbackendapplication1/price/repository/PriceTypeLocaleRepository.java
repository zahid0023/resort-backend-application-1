...
public interface PriceTypeLocaleRepository extends JpaRepository<@NonNull PriceTypeLocaleEntity, @NonNull Long> {

    Optional<PriceTypeLocaleEntity> findByPriceTypeEntity_IdAndIdAndIsActiveAndIsDeleted(
            Long priceTypeId, Long id, Boolean isActive, Boolean isDeleted);
}
