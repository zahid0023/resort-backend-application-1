...
public class FacilityPriceTypeLocaleEntity extends AuditableEntity {
    ...
    /** Internal — call via {@link FacilityPriceTypeEntity#addFacilityPriceTypeLocaleEntity}. */
    public void assignFacilityPriceType(FacilityPriceTypeEntity facilityPriceTypeEntity) {
        this.facilityPriceTypeEntity = facilityPriceTypeEntity;
    }

    /** Internal — call via {@link FacilityPriceTypeEntity#removeFacilityPriceTypeLocaleEntity}. */
    public void unassignFacilityPriceType() {
        this.facilityPriceTypeEntity = null;
    }
    ...
    /** Internal — call via {@link LocaleEntity#addFacilityPriceTypeLocaleEntity}. */
    public void assignLocale(LocaleEntity localeEntity) {
        this.localeEntity = localeEntity;
    }

    /** Internal — call via {@link LocaleEntity#removeFacilityPriceTypeLocaleEntity}. */
