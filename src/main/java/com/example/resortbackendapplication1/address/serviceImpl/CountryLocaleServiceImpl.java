...
public class CountryLocaleServiceImpl implements CountryLocaleService {
    ...
    @Override
    public LocaleCountResponse getCount(Long countryId) {
        List<String> codes = countryLocaleRepository
                .findLocaleEntity_CodeByCountryEntity_IdAndIsActiveAndIsDeleted(countryId, true, false);
