...
public class PaymentProviderFilterRequest extends PaginatedRequest implements Filterable {

    @Override
    public List<Predicate> toPredicates(Root<?> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        return SpecificationUtils.buildSearchPredicates(this, PaymentProviderSearchField.values(), root, query, cb, null);
    }
}
