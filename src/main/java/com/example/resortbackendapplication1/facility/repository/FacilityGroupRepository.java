...
public interface FacilityGroupRepository extends
        JpaRepository<@NonNull FacilityGroupEntity, @NonNull Long>,
    ...
    List<@NonNull FacilityGroupEntity> findAllByIdInAndIsActiveAndIsDeleted(Set<Long> ids, Boolean isActive, Boolean isDeleted);
