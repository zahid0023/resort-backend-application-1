...
public class FacilityFacilityGroupAssignmentEntity extends AuditableEntity {
    ...
    /** Internal — call via {@link FacilityEntity#addFacilityFacilityGroupAssignmentEntity}. */
    public void assignFacility(FacilityEntity facilityEntity) {
        this.facilityEntity = facilityEntity;
    }

    /** Internal — call via {@link FacilityEntity#removeFacilityFacilityGroupAssignmentEntity}. */
    ...
    /** Internal — call via {@link FacilityGroupEntity#addFacilityFacilityGroupAssignmentEntity}. */
    public void assignFacilityGroup(FacilityGroupEntity facilityGroupEntity) {
        this.facilityGroupEntity = facilityGroupEntity;
    }

    /** Internal — call via {@link FacilityGroupEntity#removeFacilityFacilityGroupAssignmentEntity}. */
