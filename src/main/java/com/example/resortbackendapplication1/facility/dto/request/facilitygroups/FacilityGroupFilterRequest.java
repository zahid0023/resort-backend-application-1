...
public class FacilityGroupFilterRequest extends PaginatedRequest implements Filterable {
    private String code;

    @Override
    public List<Predicate> toPredicates(Root<?> root, CriteriaBuilder cb) {
        List<Predicate> predicates = new ArrayList<>();
        for (FacilityGroupSearchField field : FacilityGroupSearchField.values()) {
