...
public class ResortPermissionTypeFilterRequest extends PaginatedRequest implements Filterable {
    ...
    public List<Predicate> toPredicates(Root<?> root, CriteriaBuilder cb) {
        ...
        for (ResortPermissionTypeSearchField field : ResortPermissionTypeSearchField.values()) {
