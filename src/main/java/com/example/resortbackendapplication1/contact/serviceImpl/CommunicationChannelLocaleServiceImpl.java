...
public class CommunicationChannelLocaleServiceImpl implements CommunicationChannelLocaleService {
    ...
    @Override
    public LocaleCountResponse getCount(Long communicationChannelId) {
        List<String> codes = communicationChannelLocaleRepository
                .findLocaleEntity_CodeByCommunicationChannelEntity_IdAndIsActiveAndIsDeleted(communicationChannelId, true, false);
