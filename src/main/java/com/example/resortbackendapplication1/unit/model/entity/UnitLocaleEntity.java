...
@Setter
@Entity
@Table(name = "unit_locales", uniqueConstraints = @UniqueConstraint(columnNames = {"unit_id", "locale_id"}))
public class UnitLocaleEntity extends AuditableEntity {
    ...
    /** Internal — call via {@link UnitEntity#addUnitLocaleEntity}. */
    public void assignUnit(UnitEntity unitEntity) {
        this.unitEntity = unitEntity;
    }

    /** Internal — call via {@link UnitEntity#removeUnitLocaleEntity}. */
    ...
    /** Internal — call via {@link LocaleEntity#addUnitLocaleEntity}. */
    public void assignLocale(LocaleEntity localeEntity) {
        this.localeEntity = localeEntity;
    }

    /** Internal — call via {@link LocaleEntity#removeUnitLocaleEntity}. */
