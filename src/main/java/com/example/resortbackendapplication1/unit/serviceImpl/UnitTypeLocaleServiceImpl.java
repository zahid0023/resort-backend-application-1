...
import com.example.resortbackendapplication1.unit.repository.UnitTypeLocaleRepository;
import com.example.resortbackendapplication1.unit.service.UnitTypeLocaleService;
...
public class UnitTypeLocaleServiceImpl implements UnitTypeLocaleService {
    ...
    @Override
    public LocaleCountResponse getCount(Long unitTypeId) {
        List<String> codes = unitTypeLocaleRepository
                .findLocaleEntity_CodeByUnitTypeEntity_IdAndIsActiveAndIsDeleted(unitTypeId, true, false);
