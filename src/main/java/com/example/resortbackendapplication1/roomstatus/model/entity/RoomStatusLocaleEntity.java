...
@Setter
@Entity
@Table(name = "room_status_locales")
public class RoomStatusLocaleEntity extends AuditableEntity {
    ...
    /** Internal — call via {@link RoomStatusEntity#addRoomStatusLocaleEntity}. */
    public void assignRoomStatus(RoomStatusEntity roomStatusEntity) {
        this.roomStatusEntity = roomStatusEntity;
    }

    /** Internal — call via {@link RoomStatusEntity#removeRoomStatusLocaleEntity}. */
    ...
    /** Internal — call via {@link LocaleEntity#addRoomStatusLocaleEntity}. */
    public void assignLocale(LocaleEntity localeEntity) {
        this.localeEntity = localeEntity;
    }

    /** Internal — call via {@link LocaleEntity#removeRoomStatusLocaleEntity}. */
