...
@Setter
@Entity
@Table(name = "resort_room_locales")
public class ResortRoomLocaleEntity extends AuditableEntity {
    ...
    /** Internal — call via {@link ResortRoomEntity#addResortRoomLocaleEntity}. */
    public void assignResortRoom(ResortRoomEntity resortRoomEntity) {
        this.resortRoomEntity = resortRoomEntity;
    }

    /** Internal — call via {@link ResortRoomEntity#removeResortRoomLocaleEntity}. */
    ...
    /** Internal — call via {@link LocaleEntity#addResortRoomLocaleEntity}. */
    public void assignLocale(LocaleEntity localeEntity) {
        this.localeEntity = localeEntity;
    }

    /** Internal — call via {@link LocaleEntity#removeResortRoomLocaleEntity}. */
