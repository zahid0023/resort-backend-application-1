...
@Setter
@Entity
@Table(name = "resort_room_metas")
public class ResortRoomMetaEntity extends AuditableEntity {
    ...
    /** Internal — call via {@link ResortRoomEntity#assignResortRoomMetaEntity}. */
    public void assignResortRoom(ResortRoomEntity resortRoomEntity) {
        this.resortRoomEntity = resortRoomEntity;
    }

    /** Internal — call via {@link ResortRoomEntity#unassignResortRoomMetaEntity}. */
