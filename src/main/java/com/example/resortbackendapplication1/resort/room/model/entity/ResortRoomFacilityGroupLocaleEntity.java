...
@Setter
@Entity
@Table(name = "resort_room_facility_group_locales")
public class ResortRoomFacilityGroupLocaleEntity extends AuditableEntity {
    ...
    /** Internal — call via {@link ResortRoomFacilityGroupEntity#addResortRoomFacilityGroupLocaleEntity}. */
    ...
    /** Internal — call via {@link ResortRoomFacilityGroupEntity#removeResortRoomFacilityGroupLocaleEntity}. */
    ...
    /** Internal — call via {@link LocaleEntity#addResortRoomFacilityGroupLocaleEntity}. */
    public void assignLocale(LocaleEntity localeEntity) {
        this.localeEntity = localeEntity;
    }

    /** Internal — call via {@link LocaleEntity#removeResortRoomFacilityGroupLocaleEntity}. */
