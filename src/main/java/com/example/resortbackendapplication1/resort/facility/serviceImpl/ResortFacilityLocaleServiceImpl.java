...
import com.example.resortbackendapplication1.resort.facility.repository.ResortFacilityLocaleRepository;
import com.example.resortbackendapplication1.resort.facility.service.ResortFacilityLocaleService;
...
public class ResortFacilityLocaleServiceImpl implements ResortFacilityLocaleService {
    ...
    @Override
    public ResortFacilityLocaleCountResponse getActiveCount(Long resortFacilityId) {
        List<String> codes = resortFacilityLocaleRepository
                .findLocaleCodeByResortFacilityEntity_IdAndIsActiveAndIsDeleted(resortFacilityId, true, false);
        return new ResortFacilityLocaleCountResponse((long) codes.size(), codes);
    }
