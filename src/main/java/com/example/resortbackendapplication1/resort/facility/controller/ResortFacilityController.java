...
public class ResortFacilityController {
    ...
    public ResponseEntity<?> create(
        ...
        FacilityPriceTypeEntity facilityPriceTypeEntity = priceRequest != null
                ? facilityPriceTypeService.getEntityById(priceRequest.getPriceTypeId())
                : null;
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(resortFacilityService.create(request, resortEntity, resortFacilityGroupEntity, facilityEntity,
                        localeEntity, allDaysOfWeek, facilityPriceTypeEntity, priceUnitEntity, currencyEntity));
    }
