...
public class ResortFacilityGroupLocaleController {
    ...
    public ResponseEntity<?> getAll(
        ...
        ResortFacilityGroupEntity resortFacilityGroupEntity = resortFacilityGroupService.getEntityById(resortId, resortFacilityGroupId);
    ...
    public ResponseEntity<?> getActiveCount(
            ...
            @PathVariable("resort-facility-group-id") Long resortFacilityGroupId) {
        ResortFacilityGroupEntity resortFacilityGroupEntity = resortFacilityGroupService.getEntityById(resortId, resortFacilityGroupId);
        return ResponseEntity.ok(resortFacilityGroupLocaleService.getActiveCount(resortFacilityGroupEntity.getId()));
    }
