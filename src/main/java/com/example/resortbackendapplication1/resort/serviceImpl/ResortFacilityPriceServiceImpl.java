...
import com.example.resortbackendapplication1.resort.dto.response.resortfacilityprices.ResortFacilityPriceResponse;
...
import com.example.resortbackendapplication1.resort.repository.ResortFacilityPriceRepository;
...
public class ResortFacilityPriceServiceImpl implements ResortFacilityPriceService {
    ...
    public SuccessResponse create(CreateResortFacilityPriceRequest request,
        ...
        ResortFacilityPriceEntity entity = ResortFacilityPriceMapper.create(
                request, priceTypeEntity, priceUnitEntity, currencyEntity);
