...
import com.example.resortbackendapplication1.resort.roomcategory.repository.ResortRoomCategoryLocaleRepository;
import com.example.resortbackendapplication1.resort.roomcategory.service.ResortRoomCategoryLocaleService;
...
public class ResortRoomCategoryLocaleServiceImpl implements ResortRoomCategoryLocaleService {
    ...
    @Override
    public ResortRoomCategoryLocaleCountResponse getActiveCount(Long resortRoomCategoryId) {
        List<String> codes = resortRoomCategoryLocaleRepository
                .findLocaleCodeByResortRoomCategoryEntity_IdAndIsActiveAndIsDeleted(resortRoomCategoryId, true, false);
        return new ResortRoomCategoryLocaleCountResponse((long) codes.size(), codes);
    }
