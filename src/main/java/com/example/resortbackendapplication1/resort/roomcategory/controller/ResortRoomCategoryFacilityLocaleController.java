...
import com.example.resortbackendapplication1.resort.roomcategory.service.ResortRoomCategoryFacilityLocaleService;
...
@RestController
@RequestMapping("/api/v1/resorts/{resort-id}/room-categories/{resort-room-category-id}/facilities/{resort-room-category-facility-id}/locales")
public class ResortRoomCategoryFacilityLocaleController {
    ...
    public ResponseEntity<?> getAll(
        ...
        ResortRoomCategoryFacilityEntity resortRoomCategoryFacilityEntity =
                resortRoomCategoryFacilityService.getEntityById(resortRoomCategoryId, resortRoomCategoryFacilityId);
    ...
    public ResponseEntity<?> getActiveCount(
        ...
        ResortRoomCategoryFacilityEntity resortRoomCategoryFacilityEntity =
                resortRoomCategoryFacilityService.getEntityById(resortRoomCategoryId, resortRoomCategoryFacilityId);
        return ResponseEntity.ok(resortRoomCategoryFacilityLocaleService.getActiveCount(resortRoomCategoryFacilityEntity.getId()));
    }
