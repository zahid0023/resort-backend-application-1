...
public class ResortRoomCategoryEntity extends AuditableEntity {
    ...
    public void addResortRoomEntity(ResortRoomEntity entity) {
        addChild(resortRoomEntities, entity, ResortRoomEntity::assignResortRoomCategory, this);
    }

    public void removeResortRoomEntity(ResortRoomEntity entity) {
        removeChild(resortRoomEntities, entity, (child, ignored) -> child.unassignResortRoomCategory());
    }
    ...
    @OneToMany(mappedBy = "resortRoomCategoryEntity", cascade = CascadeType.ALL, orphanRemoval = true)
    private Set<ResortRoomCategoryMainPriceEntity> resortRoomCategoryMainPriceEntities = new LinkedHashSet<>();

    // -------------------------------------------------------------------------
    // ResortRoomCategoryMainPrice relationship helpers
    // -------------------------------------------------------------------------

    public void addResortRoomCategoryMainPriceEntity(ResortRoomCategoryMainPriceEntity entity) {
        addChild(resortRoomCategoryMainPriceEntities, entity, ResortRoomCategoryMainPriceEntity::assignResortRoomCategory, this);
    }

    public void removeResortRoomCategoryMainPriceEntity(ResortRoomCategoryMainPriceEntity entity) {
        removeChild(resortRoomCategoryMainPriceEntities, entity, (child, ignored) -> child.unassignResortRoomCategory());
    }

    @OneToMany(mappedBy = "resortRoomCategoryEntity", cascade = CascadeType.ALL, orphanRemoval = true)
    private Set<ResortRoomCategorySpecialPriceEntity> resortRoomCategorySpecialPriceEntities = new LinkedHashSet<>();

    // -------------------------------------------------------------------------
    // ResortRoomCategorySpecialPrice relationship helpers
    // -------------------------------------------------------------------------

    public void addResortRoomCategorySpecialPriceEntity(ResortRoomCategorySpecialPriceEntity entity) {
        addChild(resortRoomCategorySpecialPriceEntities, entity, ResortRoomCategorySpecialPriceEntity::assignResortRoomCategory, this);
    }

    public void removeResortRoomCategorySpecialPriceEntity(ResortRoomCategorySpecialPriceEntity entity) {
        removeChild(resortRoomCategorySpecialPriceEntities, entity, (child, ignored) -> child.unassignResortRoomCategory());
    }
}
