...
public class MailProviderConfigFilterRequest extends PaginatedRequest implements Filterable {
    private String name;
    ...
    public List<Predicate> toPredicates(Root<?> root, CriteriaQuery<?> query, CriteriaBuilder cb) {
        ...
        for (MailProviderConfigSearchField field : MailProviderConfigSearchField.values()) {
