...
-- seed: price scope locales (english)
insert into price_scope_locales (price_scope_id, locale_id, name, sort_order, created_by, updated_by)
values ((select id from price_scopes where code = 'ROOM_CATEGORY'), (select id from locales where code = 'en'),
        'Room Category', 1, (select id from users where username = 'system'),
        (select id from users where username = 'system')),
       ((select id from price_scopes where code = 'ROOM'), (select id from locales where code = 'en'),
        'Room', 2, (select id from users where username = 'system'),
        (select id from users where username = 'system')),
       ((select id from price_scopes where code = 'RESORT_FACILITY'), (select id from locales where code = 'en'),
